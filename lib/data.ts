const dummyData = {
    ...
    customizations: [
        ...
        { name: "Mushrooms", price: 20, type: "topping" },
        { name: "Tomatoes", price: 10, type: "topping" },
        { name: "Bacon", price: 35, type: "topping" },
        { name: "Avocado", price: 45, type: "topping" },

        // Sides
        { name: "Coke", price: 40, type: "side" },
        { name: "Fries", price: 50, type: "side" },
        { name: "Garlic Bread", price: 45, type: "side" },
        { name: "Chicken Nuggets", price: 60, type: "side" },
        { name: "Iced Tea", price: 40, type: "side" },
        { name: "Salad", price: 35, type: "side" },
        { name: "Potato Wedges", price: 45, type: "side" },
        { name: "Mozzarella Sticks", price: 55, type: "side" },
        { name: "Sweet Corn", price: 30, type: "side" },
